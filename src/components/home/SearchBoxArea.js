  ...
  return (
    <Container>
      ...
      <Row className='justify-content-md-center'>
        <Col lg='3'>
          <Form.Group>
            <Form.Control as='select' size='lg' onChange={e => setCantonName(e.target.value)}>
              ...
              <option className='option'>
                Zug
              </option> <option className='option'>
                Freiburg
              </option>
              <option className='option'>
                Solothurn
        ...
        <Col lg='3' md='auto'>
          <Form.Group>
            <Form.Control as='select' size='lg' onChange={e => setProductType(e.target.value)}>
              <option className='option' selected>
                Products
              </option>
              <option>
